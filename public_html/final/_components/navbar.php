<nav class="navbar navbar-expand-lg bg-light navbar navbar-dark bg-dark shadow-lg">
  <div class="container-fluid">
    <a class="navbar-brand link-primary bg-black p-2 shadow rounded" href="./index.php">UXID Quick Recipes</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="./index.php">All Recipes</a>
        </li>
        <!-- <li class="nav-item">
